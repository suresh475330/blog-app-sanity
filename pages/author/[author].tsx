...
const Index = ({author} :Author)=>{
    
    return(
        <> 
         <div className="h-full md:max-h-full w-full bg-white">
        <Navbar />
  ...
  <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
      ...
      <div className="p-4 md:p-12 text-center lg:text-left">
          ...
          <img src={urlFor(author[0].image.asset._ref).url()} className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center "></img>
          
          <h1 className="text-3xl font-bold pt-8 lg:pt-0">{author[0].name}</h1>
          ...
          <p className="pt-8 text-sm">{author[0].bio[0].children[0].text}</p>
  ...
  <div className="w-full lg:w-2/5">
      ...
      <img src={urlFor(author[0].image.asset._ref).url()} className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block"/>
